    ...
    <section className="lp-leaderboard">
      ...
      {tab === "recipients" && network === "devnet" ? (
        ...
        <>
          ...
          <section
            className="lp-panel lp-leaderboard-board"
            aria-busy={loading}
          >
                    ...
                    .map((trader) => (
                      ...
                      >
                        ...
                        <td className="lp-leaderboard-extra">
                          <strong>
                            {trader.trades.toLocaleString("en-US")}
                          </strong>
                          <small>
          ...
          <details className="lp-office-notes">
            ...
            <p>
              Ranked by indexed buy and sell volume across OneOnly tokens,
              including trades through other apps. USD values use prices
              recorded at the time of each trade. Unpriced trades and history
              still being indexed are excluded.
            </p>
            <p>
              Wallets are identified from indexed transactions; sponsored routes
              may appear under the transaction payer. Volume measures activity,
              not profit or unique people. Only the top 100 are shown.
            </p>
          </details>
        </>
      )}
